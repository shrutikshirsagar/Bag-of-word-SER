...
df = pd.read_csv('/media/amrgaballah/Backup_Plus/exp_j1/emotiW_feat_BOW/Train_final_all.csv').values
...
df1 = pd.read_csv('/media/amrgaballah/Backup_Plus/exp_j1/emotiW_feat_BOW/Val_final_all.csv').values
